                    ...
                    foreach ($login->result() as $l) : ?>
                                <tr class="putih">
                                    ...
                                    <td> <a data-bs-toggle="modal" data-bs-target="#hapus<?= $l->id; ?>" href=""
                                            class="btn btn-danger "><i class="bi bi-trash text-white"></i></a>
                                    </td>
                                </tr>
                                <?php endforeach; ?>
                            </tbody>
        ...
        <div class="modal-dialog">
            <div class="modal-content">
                <div class="modal-header head">
                    <h5 class="modal-title bold" id="exampleModalLabel">Akses Login Dosen</h5>
                </div>
                <div class="modal-body">
                    <form action="<?php echo base_url('administrator/tambah_akses_dosen') ?>" method="post">
                        <div class="mb-2">
    ...
    <div class="modal fade" id="hapus<?= $l->id; ?>" tabindex="-1" aria-labelledby="exampleModalLabel"
        ...
        <div class="modal-dialog">
            <div class="modal-content">
                ...
                <form action="<?= base_url('administrator/hapus_dosen/' . $l->id) ?>" method="POST">
                    <div class="modal-footer">
