...
<head>
    ...
    <title> Login - Portal Mahasiswa Institute</title>
    ...
    <link href="<?= base_url() ?>assets/front/vendor/quill/quill.snow.css" rel="stylesheet">
    <link href="<?= base_url() ?>assets/front/vendor/quill/quill.bubble.css" rel="stylesheet">
    <link href="<?= base_url() ?>assets/front/vendor/remixicon/remixicon.css" rel="stylesheet">
    <link href="<?= base_url() ?>assets/front/vendor/simple-datatables/style.css" rel="stylesheet">
...
<body>
                            ...
                            <div class="col-lg-4 col-md-6 d-flex flex-column align-items-center justify-content-center">
                                <div class="d-flex justify-content-center login-logo">
                                    <a href="index.html" class="d-flex align-items-center w-auto">
                                        <img src="<?= base_url() ?>assets/front/img/logo-mobile.png">
                                    </a>
                                </div><!-- End Logo -->
                                ...
                                <div class="card mb-3">
                                    <div class="card-body p-4">
                                        <div class=" pb-2">
                                            <h5 class="card-title1 text-center pb-0 fs-4">Administrator</h5>
                                            <p class="text-center small">masukan username & password untuk login</p>
                                        </div>
                                        <form class="row g-3 needs-validation" method="POST" action="<?= base_url() ?>login_admin/logproses/" novalidate>
                                            <div class="col-12">
                                            ...
                                            <div class="col-12">
                                                ...
                                                <!-- <div class="invalid-feedback">Mohon masukan password anda</div> -->
                                            </div>
                                            <div class="col-12">
    ...
    <script src="<?= base_url() ?>assets/front/vendor/chart.js/chart.min.js"></script>
