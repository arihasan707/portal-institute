                ...
                <div class="form-content">
                    <div class="form-items">
                        <div class="logo d-flex justify-content-center mb-3">
                            <img src="<?= base_url()?>assets/front/img/logo-mobile.png" width="150px">
                        </div>
                        ...
                        <div class="page-links">
                            <a href="<?= base_url('login')?>">Login sebagai mahasiswa</a>
                            <a href="<?= base_url('login/dosen')?>" class="active">Login sebagai dosen</a>
                        </div>
                        <form action="<?= base_url('login/logproses1')?>" method="post">
