<body>
    ...
    <header id="header" class="header fixed-top d-flex align-items-center">
        ...
        <div class="d-flex align-items-center justify-content-between">
            <a href="<?= base_url('portal_mahasiswa')?>" class="d-flex align-items-center">
        ...
        <div class="logo1 d-flex align-items-center justify-content-between">
            <a href="<?= base_url('portal_mahasiswa')?>" class="d-flex align-items-center pt-1">
            ...
            <ul class="d-flex align-items-center">
                ...
                <li class="nav-item dropdown pe-3">
                    ...
                    <a class="nav-link nav-profile d-flex align-items-center pe-0" href="#" data-bs-toggle="dropdown">
                        <img src="<?= base_url() ?>assets/front/upload/<?php if($users->foto == '-')
                        {
                        ...
                        <span class="d-none d-md-block dropdown-toggle ps-2 text-white"><?= $users->nama ?></span>
                    ...
                    <ul class="dropdown-menu dropdown-menu-end dropdown-menu-arrow profile">
                        ...
                        <li>
                            <a class="dropdown-item d-flex align-items-center"
                                href="<?= base_url('portal_mahasiswa/profil')?>">
                        ...
                        <li>
                            <a class="dropdown-item d-flex align-items-center"
                                href="<?= base_url('portal_mahasiswa/keluar') ?>">
